...
DELIVERY_TRANSITIONS = {
    ...
    "exception_review_routing": {"deck_consistency_review", "p5_failed"},
    "deck_consistency_review": {"evaluating_delivery_policy", "live_review_pending", "p5_failed"},
    "live_review_pending": {"evaluating_delivery_policy", "p5_failed"},
