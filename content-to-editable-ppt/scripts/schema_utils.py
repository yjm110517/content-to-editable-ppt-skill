...
SCHEMA_FILES = {
    ...
    "markdown_wireframe_candidate": "markdown-wireframe-candidate.schema.json",
    "markdown_wireframe_manifest": "markdown-wireframe-manifest.schema.json",
    "markdown_wireframe_validation_report": "markdown-wireframe-validation-report.schema.json",
    "markdown_wireframe_correction_record": "markdown-wireframe-correction-record.schema.json",
    ...
    "design_preview_batch_state": "design-preview-batch-state.schema.json",
    "design_element_map_input_manifest": "design-element-map-input-manifest.schema.json",
    "design_element_map_call_record": "design-element-map-call-record.schema.json",
    ...
    "storyboard_anchor_compatibility_record": "storyboard-anchor-compatibility-record.schema.json",
    ...
    "reconstruction_asset_manifest": "reconstruction-asset-manifest.schema.json",
    "reconstruction_seed": "reconstruction-seed.schema.json",
    "reconstruction_seed_view": "reconstruction-seed-view.schema.json",
    "visual_reconstruction_spec": "visual-reconstruction-spec.schema.json",
    "reconstruction_validation_report": "reconstruction-validation-report.schema.json",
    "reconstruction_patch": "reconstruction-patch.schema.json",
    "reconstruction_page_state": "reconstruction-page-state.schema.json",
    "reconstruction_deck_state": "reconstruction-deck-state.schema.json",
    "reconstruction_build_report": "reconstruction-build-report.schema.json",
    "visual_fidelity_report": "visual-fidelity-report.schema.json",
    ...
    "p5_reviewer_call_record": "p5-reviewer-call-record.schema.json",
...
SUPPORTED_SCHEMA_VERSIONS = {
    ...
    "markdown_wireframe_candidate": {"1.1", "1.2"},
    "markdown_wireframe_manifest": {"1.1", "1.2"},
    "markdown_wireframe_validation_report": {"1.0"},
    "markdown_wireframe_correction_record": {"1.0"},
    ...
    "design_preview_batch_state": {"1.0"},
    "design_element_map_input_manifest": {"1.0"},
    "design_element_map_call_record": {"1.0"},
    ...
    "storyboard_anchor_compatibility_record": {"1.0"},
    ...
    "reconstruction_asset_manifest": {"1.0"},
    "reconstruction_seed": {"1.0"},
    "reconstruction_seed_view": {"1.0"},
    "visual_reconstruction_spec": {"1.0"},
    "reconstruction_validation_report": {"1.0"},
    "reconstruction_patch": {"1.0"},
    "reconstruction_page_state": {"1.0"},
    "reconstruction_deck_state": {"1.0"},
    "reconstruction_build_report": {"1.0"},
    "visual_fidelity_report": {"1.0"},
    ...
    "deck_consistency_reviewer_response": {"1.0", "1.1"},
    "p5_reviewer_call_record": {"1.0"},
